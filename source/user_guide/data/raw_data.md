...
**描述：** BJ_TRAJ 数据集包含海量轨迹数据，每月约 1.44 亿条。 有数月的数据可用，实现中只给出了六月的数据。
...
**描述：** CD_TRAJ 数据集包含海量轨迹数据，每 10 天约 5.91 亿条。 有 2 个月的数据可用。
...
**描述：** XA_TRAJ 数据集包含海量轨迹数据，每 15 天约 6.88 亿条。 有 2 个月的数据可用。
